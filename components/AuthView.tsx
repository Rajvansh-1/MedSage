    ...
    <div className="min-h-screen bg-indian-cream/30 flex flex-col items-center justify-center p-4">
      <div className="glass-card p-8 rounded-3xl shadow-lg-xl w-full max-w-md text-center border border-indian-brown/10">
        ...
        <div className="space-y-4">
           ...
           <button 
             onClick={login}
             className="w-full glass-card border border-indian-brown/20 text-indian-brown/90 py-3 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-indian-cream/30 transition-colors"
           >
           ...
           <button 
             ...
             className="w-full glass-card border border-indian-brown/20 text-indian-brown/90 py-3 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-indian-cream/30 transition-colors"
           >
              <Mail size={20} className="text-indian-brown/60"/>
              Continue with Email
           </button>
        </div>
        
        <p className="mt-8 text-xs text-indian-brown/60">By continuing, you agree to our Terms of Service.</p>
      </div>
    </div>
  );
};
