...
const SleepView: React.FC = () => {
  ...
  if (sleepLog) {
    return (
      <div className="max-w-3xl mx-auto p-4 md:p-6 pb-24 md:pb-6">
        <div className="bg-indigo-900 text-white rounded-3xl p-6 md:p-8 shadow-lg-xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-8 mb-8 relative z-10">
            <div className="glass-card/10 rounded-2xl p-4 md:p-6 text-center backdrop-blur-sm">
            ...
            <div className="glass-card/10 rounded-2xl p-4 md:p-6 text-center backdrop-blur-sm flex flex-col justify-center items-center">
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-6 pb-24 md:pb-6">
      <div className="glass-card rounded-2xl shadow-lg-md border border-indian-brown/10 p-6 md:p-8">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-indigo-50 text-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4">
            <Moon size={32} />
          </div>
          <h2 className="text-2xl font-bold text-indian-brown">Log Sleep & Dreams</h2>
          <p className="text-indian-brown/70">How did you rest last night?</p>
        </div>

        <div className="space-y-6 animate-slide-up">
          <div className="grid grid-cols-2 gap-4">
            <div>
                <label className="block text-sm font-medium text-indian-brown/90 mb-1">Bedtime</label>
                <div className="relative">
                    <Clock size={16} className="absolute left-3 top-3 text-indian-brown/60" />
                    <input 
                        type="time" 
                        value={bedTime}
                        onChange={(e) => setBedTime(e.target.value)}
                        className="w-full pl-10 p-2 border border-indian-brown/20 rounded-lg focus:outline-none focus:border-indigo-500"
                    />
                </div>
            </div>
            <div>
                <label className="block text-sm font-medium text-indian-brown/90 mb-1">Wake Time</label>
                <div className="relative">
                    <Clock size={16} className="absolute left-3 top-3 text-indian-brown/60" />
                    <input 
                        type="time" 
          ...
          <div>
            <label className="block text-sm font-medium text-indian-brown/90 mb-2">Quality</label>
                ...
                {(['Poor', 'Fair', 'Good', 'Excellent'] as SleepQuality[]).map((q) => (
                    <button
                        ...
                        className={`py-2 px-1 rounded-lg text-sm border transition-all ${
                            ...
                            : 'glass-card text-indian-brown/80 border-indian-brown/20 hover:bg-indian-cream/30'
                        }`}
                    >
                        {q}
                    </button>
          ...
          <div>
            <label className="block font-medium text-indian-brown/90 mb-2 flex items-center gap-2">
              <CloudMoon size={18} />
              Dream Journal <span className="text-indian-brown/60 font-normal text-xs">(Optional)</span>
            </label>
            <textarea
              className="w-full border border-indian-brown/20 rounded-xl p-4 h-32 focus:outline-none focus:ring-2 focus:ring-indigo-200 resize-none"
          ...
          <button 
            ...
            disabled={analyzing}
            className="w-full bg-indigo-600 text-white py-3 rounded-xl font-bold hover:bg-indigo-700 transition-colors shadow-lg-lg shadow-lg-indigo-200"
          >
